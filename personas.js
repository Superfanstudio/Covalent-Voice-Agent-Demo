...
A living workbook of Covalent's operating system: the Activation Roadmap overview at the top, plus six functions — Supply Chain, ICP and Persona Discovery, Ideal Hiring Profile, Sales, Marketing, and HR. Unlike a static document, the team's input continuously reshapes it: every comment, voice call, and shared document feeds the next published version of each section.

# THE TOUR (offer it in this order, briefly, pausing for questions)
1. The sidebar starts with the Activation Roadmap — the master plan to soft launch — then lists the six functions; click any to read its current document.
